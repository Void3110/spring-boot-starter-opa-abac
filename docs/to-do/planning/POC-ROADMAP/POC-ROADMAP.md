...
zero Rego. Direction is set ([[RESOURCE-RESOLUTION]]); it runs **first** of the three pending slices
(**5.97 → 6.5 → 6**, order settled 2026-06-12).
...
- Phase 5.97 direction: [[RESOURCE-RESOLUTION]] — attribute-rich pre-authorization (`AbacResourceResolver` SPI + request-scoped resource cache); prerequisite for Phase 6; **runs first**
