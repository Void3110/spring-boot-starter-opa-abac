...
- Phase 7.2 (pre-publish) **load testing** [[LOAD-TESTING]] — **design settled + decomposed** (grill-me 2026-07-07, pinned by [[0021-load-testing-methodology|ADR 0021]]): a committed k6 harness (`scripts/load/`) measuring the four library hot paths + the cross-service amplification ratio through the real rig, two-pass guarded/unguarded delta as the headline, report-only into a root `PERFORMANCE.md`
